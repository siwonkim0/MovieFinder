...
- [이미지 처리](#------)
    + [트러블 슈팅](#------)
    + [1. 이미지 downsampling을 통한 메모리 사용량 줄이기](#1-----downsampling----------------)
    + [2. 이미지 로딩 속도 개선하기](#2---------------)
    + [3. UICollectionView 빠르게 스크롤하면 잘못된 이미지가 나타나는 현상 해결](#3-uicollectionview------------------------------)
- [Coordinator Pattern을 이용한 화면전환](#coordinator-pattern----------)
    + [구현 내용](#-----)
- [네트워크 코드 추상화](#-----------)
    + [구현 내용](#------1)
- [로그인 화면](#------)
